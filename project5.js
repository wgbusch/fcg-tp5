...
window.onload = function () {
    ...
    SetIaValue(document.getElementById('Ia'));
    SetIValue(document.getElementById('I'));
    // Dibujo la escena
    DrawScene();
};
...
function SetIaValue(param) {
    var exp = param.valueAsNumber;
    document.getElementById('Ia-value').innerText = exp;
    meshDrawer.setIaValue(exp);
    DrawScene();
}

function SetIValue(param) {
    var exp = param.valueAsNumber;
    document.getElementById('I-value').innerText = exp;
    meshDrawer.setIValue(exp);
    DrawScene();
}
